...
class SwinNet3PlusModel(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        self.encoder = SwinEncoder(image_size = 512)

        self.bottleneck = DoubleConvolution(in_channels = self.filters[4], out_channels = self.filters[4])
    ...
    def forward(self, x):
        ...
        hd4 = self.conv4d_1(torch.cat((h3_PT_hd4, hd5_UT_hd4), 1))
...
class SwinEncoder(nn.Module):
    def __init__(self, image_size = 512):
        ...
        self.model_encoder = timm.create_model(self.swin_model, pretrained = True, features_only = True, img_size = image_size)
