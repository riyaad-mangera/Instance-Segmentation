...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'dataset','labels')
        print(cityscapesPath)
    # how to search for all ground truth
    searchFine   = os.path.join( cityscapesPath , "gtFine_trainvaltest", "gtFine", "*" , "*" , "*_gt*_polygons.json" )
    searchCoarse = os.path.join( cityscapesPath , "gtCoarse", "gtCoarse" , "*" , "*" , "*_gt*_polygons.json" )
